...
const renderHighlightedQuestion = () => {
  // 🔒 Only PracticeTest should convert to English + highlight
  if (communication_category !== "PracticeTest") {
    return ALLOWED_SKILL_TYPES.includes(skillType) && translatedText
      ? translatedText
      : currentQ.question_text;
  }

  // ✅ Existing PracticeTest behavior (UNCHANGED)

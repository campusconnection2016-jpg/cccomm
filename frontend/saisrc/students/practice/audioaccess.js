...
const AudioAccess = ({ username, collegeName, institute ,communication_category}) => {
...
onMouseOut={(e) => {
  ...
  console.log("📘 Selected Question Paper:");
console.log("➡ Topic:", paper.topic);
console.log("➡ Sub Topic:", paper.sub_topic);
console.log("➡ Test Type Category:", selectedCategory);
console.log("➡ communication_category:", communication_category);
...
const { candidates_map_id, test_name, test_type_category } = response.data; // ✅ destructure here
  ...
  navigate("/test/practice-communication/", { state: { candidates_map_id, test_name, payload,test_type_category, sub_topic: paper.sub_topic,  } });

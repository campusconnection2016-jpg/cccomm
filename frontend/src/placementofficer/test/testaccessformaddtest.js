...
import QuestionPaperMCQTest from '../../components/questions/questionpapermcqtest';
import QuestionPaperCodeTest from '../../components/questions/questionpapercodetest';
  ...
  <Modal show={isModalOpen} onHide={handleModalClose} size="lg" centered>
    ...
    <Modal.Body>
      {testTypeNew === "MCQ Test" && (
        <QuestionPaperMCQTest userRole={userRole} collegeName={collegeName} selectedTestTypeCategoryPass="College" />
      )}
      {testTypeNew === "Coding Test" && (
        <QuestionPaperCodeTest userRole={userRole} collegeName={collegeName} selectedTestTypeCategoryPass="College" />
      )}
    </Modal.Body>
    {/* <Modal.Footer>
